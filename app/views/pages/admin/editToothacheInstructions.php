...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/admin/editToothacheInstructions.css">
...
<body>
	...
	<div class="form">
		<div class="frame">
			<center>
				<form method="post" id="toothacheForm" name="toothavheForm" enctype="multipart/form-data">
					<div class="row">
						<div class="namediv">
