...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/admin/editNosebleedInstructions.css">
...
<body>
	...
	<div class="breadcrum" id="breadcrum">
		<ul class="breadcrumb">
			...
			<li><a href="nosebleed">Nosebleed</a></li>
			<li>Edit</li>
		</ul>
	</div>
	<div class="form">
	...
	<script type="text/javascript" src="../javascript/editNosebleedInstructions.js"></script>
