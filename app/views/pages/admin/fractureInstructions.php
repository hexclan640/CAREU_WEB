...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/admin/fractureInstructions.css">
	...
	<title>Fracture First Aids</title>
</head>
<body>
	...
	<div class="form1">
		<div class="frame">
			<center>
				<form method="post" id="fractureForm" name="fractureForm" enctype="multipart/form-data">
					<div class="row">
						<div class="namediv">
				...
				<div class="instructioncol">
					<div class="details">
						...
						<div class="options">
							...
							<a href="editfracture?id=<?php echo $instructions->id; ?>" class="delete"><img src="../img/instructionIcons/edit.svg" alt=""></a>
						</div>
					</div>
				</div>
				<?php } ?>	
	...
	<script type="text/javascript" src="../javascript/fractureInstructions.js"></script>
