...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/admin/editSprainInstructions.css">
...
<body>
	...
	<div class="breadcrum" id="breadcrum">
		<ul class="breadcrumb">
			...
			<li><a href="bleeding">Sprain</a></li>
			<li>Edit</li>
		</ul>
	</div>
	<div class="form">
		<div class="frame">
			<center>
				<form method="post" id="sprainForm" name="sprainForm" enctype="multipart/form-data">
					<div class="row">
						<div class="namediv">
	...
	<script type="text/javascript" src="../javascript/editSprainInstructions.js"></script>
