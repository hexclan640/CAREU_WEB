...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/admin/editFractureInstructions.css">
...
<body>
	...
	<div class="breadcrum" id="breadcrum">
		<ul class="breadcrumb">
			...
			<li><a href="fracture">Fractures</a></li>
			<li>Edit</li>
		</ul>
	</div>
	<div class="form">
	...
	<script type="text/javascript" src="../javascript/editFractureInstructions.js"></script>
