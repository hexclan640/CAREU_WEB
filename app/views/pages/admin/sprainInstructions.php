...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/admin/sprainInstructions.css">
...
<body>
				...
				<div class="instructioncol">
					<div class="details">
						...
						<div class="options">
							...
							<a href="editsprain?id=<?php echo $instructions->id; ?>"><img src="../img/instructionIcons/edit.svg" alt=""></a>
						</div>
					</div>
				</div>
				<?php } ?>	
	...
	<script type="text/javascript" src="../javascript/sprainInstructions.js"></script>
