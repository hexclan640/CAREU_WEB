...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../css/admin/nosebleedInstructions.css">
	...
	<title>Nosebleed First Aids</title>
</head>
<body>
	...
	<div class="form1">
		<div class="frame">
			<center>
				<form method="post" id="nosebleedForm" name="nosebleedForm" enctype="multipart/form-data">
					<div class="row">
						<div class="namediv">
				...
				<div class="instructioncol">
					<div class="details">
						...
						<div class="options">
							...
							<a href="editnosebleed?id=<?php echo $instructions->id; ?>" class="delete"><img src="../img/instructionIcons/edit.svg" alt=""></a>
						</div>
					</div>
				</div>
				<?php } ?>	
	...
	<script type="text/javascript" src="../javascript/nosebleedInstructions.js"></script>
