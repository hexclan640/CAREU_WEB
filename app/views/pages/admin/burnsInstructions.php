...
if (isset($_POST['upload'])) {
	...
	$sql="INSERT INTO instruction3 (step,description,image) VALUES ('$step','$description','$image')";
...
<html>
<head>
	<title>Manage Instruction3</title>
	<link rel="stylesheet" href="style.css">
</head>
<body>

<h1>Instructions for Burning</h1>
<h3><a href="home_instructions.php"> < Back to Instructions home page</a></h3>
	
	<form method="post" action="manage_Instruction3.php" enctype="multipart/form-data">
